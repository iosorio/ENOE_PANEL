...
local path_in "/Users/Israel/OneDrive/Microdata/GLD/MEX/MEX_2014_ENOE-Q4/MEX_2014_ENOE_V01_M/Data/Stata"
local path_output "/Users/Israel/OneDrive/Microdata/GLD/MEX/MEX_2014_ENOE-Q4/MEX_2014_ENOE_V01_M_V06_A_GLD/Data/Harmonized"

*----------1.3: Database assembly-------------------s (if several) to have all elements needed to produce
* harmonized output in a single file
		use "`path_in'/COE1T414.dta", clear
	...
	use "`path_in'/COE2T414.dta", clear
	tostring (ent v_sel n_ren), gen(ent_str v_sel_str n_ren_str) format("%02.0f")
	tostring con, gen(con_str) format("%05.0f")
	tostring (n_hog h_mud), gen(n_hog_str h_mud_str) format("%01.0f")
	...
	* Overwrtwrite temp file
	...
	use "`path_in'/SDEMT414.dta", clear
	tostring (ent v_sel n_ren), gen(ent_str v_sel_str n_ren_str) format("%02.0f")
	tostring con, gen(con_str) format("%05.0f")
	tostring (n_hog h_mud), gen(n_hog_str h_mud_str) format("%01.0f")
...
drop p1-p3
	...
	*the harmonization is for Q4 of the year , any other month will be put to missing.
	tab d_mes
	*replace d_mes=. if d_mes == 9 | d_mes == 1
	tab d_mes, missing
