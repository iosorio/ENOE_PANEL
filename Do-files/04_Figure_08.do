...
cap log close step04
log using "Do-files/Logs/04_Figure_08.log", replace name(step04)
clear
/*******************************************************************************
* Figure 08
*******************************************************************************/
...
* Importar PPPs de WDI
	...
	* Linea de pobreza diaria en PPP (international $) - Usando Nivel de Precios de ENOE
	...
	gen double lp_0685LCU_0 = (6.85*365/12) * pa_nus_ppp * fp_cpi_totl_2017	*.85 // Rural - Standard World Bank assumption for Latin America
	...
	preserve
		...
		bys year: replace year = 2019 if year==2018 & _n==2
		...
		sort year
		drop year
		export excel using "Output/FINAL figures for MEX PEA.xlsx", sheetmodify sheet("data fig_8 ") cell(D5)
	
	restore
	
/*******************************************************************************
* End of 04_Figure_08.do
*******************************************************************************/
cap log close step04
