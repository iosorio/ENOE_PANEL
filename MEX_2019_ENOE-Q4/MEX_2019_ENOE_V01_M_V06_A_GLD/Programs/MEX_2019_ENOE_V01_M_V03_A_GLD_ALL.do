...
local path_in "/Users/Israel/OneDrive/Microdata/GLD/MEX/MEX_2019_ENOE-Q4/MEX_2019_ENOE_V01_M/Data/Stata"
local path_output "/Users/Israel/OneDrive/Microdata/GLD/MEX/MEX_2019_ENOE-Q4/MEX_2019_ENOE_V01_M_V06_A_GLD/Data/Harmonized"

*----------1.3: Database assembly-------------------s (if several) to have all elements needed to produce
* harmonized output in a single file
		use "`path_in'/COE1T419.dta", clear	
**All variables where in upper cases for 2019**
	rename *, lower
	...
	use "`path_in'/COE2T419.dta", clear
**All variables where in upper cases for 2019**
	rename *, lower
	tostring (ent v_sel n_ren), gen(ent_str v_sel_str n_ren_str) format("%02.0f")
	tostring con, gen(con_str) format("%05.0f")
	...
	* Overwrtwrite temp file
	...
	use "`path_in'/SDEMT419.dta", clear
**All variables where in upper cases for 2019**
	rename *, lower
	tostring (ent v_sel n_ren), gen(ent_str v_sel_str n_ren_str) format("%02.0f")
	tostring con, gen(con_str) format("%05.0f")
...
**All variables where in upper cases for 2019**
	...
	*the harmonization is for Q4 of the year , any other month will be put to missing.
	tab d_mes
	*replace d_mes=. if d_mes == 1 | d_mes == 9
	tab d_mes, missing
