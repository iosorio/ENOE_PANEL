...
<_Program name_>				[MEX_2025_ENOE_V01_M_V07_A_GLD_ALL.do] </_Program name_>
...
<_Sample size (HH)_> 			[125,205] </_Sample size (HH)_>
<_Sample size (IND)_> 			[411,562] </_Sample size (IND)_>
...
local path_output   "`server'/`level_1'-`quarter'/`level_2_harm'/Data/Harmonized"
...
if `use_enoen_ext'{;
	...
	rename *, lower;
	* Normalize geographic codes (INEGI renamed ent->cve_ent, etc. from 2025Q3);
	cap confirm var cve_ent;
	if !_rc gen ent = cve_ent;
	cap confirm var cve_mun;
	if !_rc gen mun = cve_mun;
	cap confirm var cve_loc;
	if !_rc gen loc = cve_loc;
	cap destring ent, replace;
...
*selected main cities from states
	...
	label define lblsubnatid2 1 "Ciudad de México" 2 "Guadalajara" 3 "Monterrey" 4 "Puebla" 5 "León" 6 "Torreón" 7 "San Luis Potosí" 8 "Mérida" 9 "Chihuahua" 10 "Tampico" 12 "Veracruz" 13 "Acapulco" 14 "Aguascalientes" 15 "Morelia" 16 "Toluca" 17 "Saltillo" 18 "Villahermosa" 19 "Tuxtla Gutiérrez" 20 "Ciudad Juárez" 21 "Tijuana" 24 "Culiacán" 25 "Hermosillo" 26 "Durango" 27 "Tepic" 28 "Campeche" 29 "Cuernavaca" 30 "Coatzacoalcos" 31 "Oaxaca" 32 "Zacatecas" 33 "Colima" 36 "Querétaro" 39 "Tlaxcala" 40 "La Paz"41 "Cancún" 42 "Ciudad del Carmen" 43 "Pachuca" 44 "Mexicali" 46 "Reynosa" 52 "Tapachula" 81 "Complemento urbano-rural" 82 "Complemento urbano-rural" 83 "Complemento urbano-rural" 84 "Complemento urbano-rural" 85 "Complemento urbano-rural" 86 "Complemento urbano-rural"
...
*selected towns within selected cities from states
	gen subnatid3 = mun
	do "`path_in_do'/ent_mun_label.do"
...
*<_% KEEP VARIABLES - ALL_>
	...
	local includevars "tamh ingreso mv lpT pob cd_a ent mun loc  con v_sel tipo mes_cal ca n_hog h_mud n_ren emp_ppal tue_ppal mh_fil2 mh_col clase2 r_def c_res zona emp_ppal tue_ppal dur_est p6b2 p6c"
