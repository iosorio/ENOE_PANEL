...
local path_in "/Users/Israel/OneDrive/Microdata/GLD/MEX/MEX_2019_ENOE-Q3/MEX_2019_ENOE_V01_M/Data/Stata"
local path_output "/Users/Israel/OneDrive/Microdata/GLD/MEX/MEX_2019_ENOE-Q3/MEX_2019_ENOE_V01_M_V06_A_GLD/Data/Harmonized"

*----------1.3: Database assembly-------------------s (if several) to have all elements needed to produce
* harmonized output in a single file
		use "`path_in'/COE1T319.dta", clear
	...
	use "`path_in'/COE2T319.dta", clear
	**All variables where in upper cases for 2019**
	rename *, lower
	tostring (ent v_sel n_ren), gen(ent_str v_sel_str n_ren_str) format("%02.0f")
	tostring con, gen(con_str) format("%05.0f")
	...
	* Overwrtwrite temp file
	...
	use "`path_in'/SDEMT319.dta", clear
	**All variables where in upper cases for 2019**
	rename *, lower
	tostring (ent v_sel n_ren), gen(ent_str v_sel_str n_ren_str) format("%02.0f")
	tostring con, gen(con_str) format("%05.0f")
